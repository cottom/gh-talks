...
var API_HOST = exports.API_HOST = 'https://api.github.com';
var AUTH_URL = exports.AUTH_URL = 'https://github.com/login/oauth/authorize';
var TOKEN_URL = exports.TOKEN_URL = 'https://github.com/login/oauth/access_token';
var GH_TALK_LOCAL_USER = exports.GH_TALK_LOCAL_USER = 'GH_TALK_LOCAL_USER';
var GH_TALK_TOKEN = exports.GH_TALK_TOKEN = 'GH_TALK_TOKEN';
...
exports.exchangeToken = exports.getToken = exports.listComments = undefined;
...
var unAuthHttp = _axios2.default.create({
    baseURL: _constant.API_HOST,
    headers: { Accept: 'application/vnd.github.full+json' }
});
var API = /** @class */function () {
    function API(token, option) {
        this.token = token;
    ...
    API.prototype.listComments = function () {
        var _a = this.ghTalkOption,
            owner = _a.owner,
            repo = _a.repo,
            issueId = _a.issueId;
        return this.$http.get("/repos/" + owner + "/" + repo + "/issues/" + issueId + "/comments");
    };
    API.prototype.createComment = function (body) {
        var _a = this.ghTalkOption,
            owner = _a.owner,
            repo = _a.repo,
            issueId = _a.issueId;
        return this.$http.post("/repos/" + owner + "/" + repo + "/issues/" + issueId + "/comments", { body: body });
    };
    API.prototype.editComment = function (id, body) {
        var _a = this.ghTalkOption,
            owner = _a.owner,
            repo = _a.repo;
        return this.$http.patch("/repos/" + owner + "/" + repo + "/issues/comments/" + id, { body: body });
    };
    API.prototype.deleteComment = function (id) {
        var _a = this.ghTalkOption,
            owner = _a.owner,
            repo = _a.repo;
        return this.$http.delete("/repos/" + owner + "/" + repo + "/issues/comments/" + id);
    };
    API.prototype.detailUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        data = _a.sent().data;
                        localStorage.setItem(_constant.GH_TALK_LOCAL_USER, JSON.stringify(data));
                        localStorage.setItem(_constant.GH_TALK_TOKEN, this.token);
                        return [2 /*return*/, data];
                    case 2:
                        error_1 = _a.sent();
                        localStorage.removeItem(_constant.GH_TALK_LOCAL_USER);
                        localStorage.removeItem(_constant.GH_TALK_TOKEN);
    ...
    API.prototype._getUser = function () {
        return this.$http.get('/user');
    };
    API.prototype.parseMarkdown = function (text) {
        return this.$http.post('/markdown', { text: text, mode: 'gfm' });
    };
    return API;
}();
exports.default = API;
var listComments = exports.listComments = function listComments(x) {
    return unAuthHttp.get("/repos/" + x.owner + "/" + x.repo + "/issues/" + x.issueId + "/comments", { params: {} });
};
var getToken = exports.getToken = function getToken(code, client_id, client_secret, exchangeTokenURL) {
    var url = exchangeTokenURL || 'https://exchange-github-token-osnxstyani.now.sh/exchange-token';
...
var exchangeToken = exports.exchangeToken = function exchangeToken(code, option) {
    return __awaiter(_this, void 0, void 0, function () {
        var clientId, clientSecret, exchangeTokenURL, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    clientId = option.clientId, clientSecret = option.clientSecret, exchangeTokenURL = option.exchangeTokenURL;
                    return [4 /*yield*/, getToken(code, clientId, clientSecret, exchangeTokenURL)];
                case 1:
                    data = _a.sent().data;
...
exports.DOMRender = undefined;

var _util = __webpack_require__(1);

var _resource = __webpack_require__(35);

var _autosize = __webpack_require__(14);
...
// const
var disappearEL = function disappearEL(el) {
    return el.classList.add('display-none');
};
var showEl = function showEl(el) {
    return el.classList.remove('display-none');
};
var LOADING_CLASS_NAME = 'gh-talk-loading';
var LOADING_CLASS_SELECTOR = "." + LOADING_CLASS_NAME;
var renderLoading = function renderLoading(container) {
    var loadingEl = container.querySelector(LOADING_CLASS_SELECTOR);
    if (loadingEl) showEl(loadingEl);else {
...
var DOMRender = /** @class */function () {
    function DOMRender(options, container) {
        var renderComments = options.renderComments,
            renderEditor = options.renderEditor;
        this._renderComments = renderComments;
        this._renderEditor = renderEditor;
        renderLoading(container);
    }
    DOMRender.prototype.render = function (meta, container) {
        container.innerHTML = '';
        ...
        (0, _autosize2.default)(textareas || []);
    };
    Object.defineProperty(DOMRender.prototype, "renderComments", {
        get: function get() {
    ...
    Object.defineProperty(DOMRender.prototype, "renderEditor", {
        get: function get() {
...
function defaultRenderComments(meta) {
    var user = meta.user,
        comments = meta.comments,
        instance = meta.instance;
    var commentEls = comments.map(function (item) {
        return renderSignComment(meta, item);
    });
...
function defaultRenderEditor(meta) {
    ...
    if (user) {
        var config = {
            saveHandler: function saveHandler(text, cb, editorContainer) {
                return __awaiter(_this, void 0, void 0, function () {
                    var res, data, commentEl, parent_1, el, error_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, instance.resource.createComment(text)];
                            case 2:
                                res = _a.sent();
                                data = res.data;
                                commentEl = renderSignComment(meta, data);
        ...
        var editorEl = renderEditor(config);
        var editorElContainer = document.createElement('div');
...
function renderEditor(config) {
    var saveHandler = config.saveHandler,
    ...
    var editContent = container.querySelector('.gh-talk-editor__content');
    var previewContent = container.querySelector('.gh-talk-editor__preview');
    var cancelBtn = container.querySelector('.gh-talk-editor__execute-cancel');
    var editBtn = container.querySelector('.gh-talk-editor__execute-submit');
    if (writeBtn && previewBtn && textarea && editContent && previewContent && editBtn) {
        disappearEL(previewContent);
        textarea.value = defaultText || '';
        // add event to items
        var switchToEdit_1 = function switchToEdit_1() {
        ...
        var switchToPreview = function switchToPreview() {
            ...
            instance.markdown(textarea.value).then(function (res) {
                return previewContent.innerHTML = res.data || '';
            }).catch(function () {
                return previewContent.innerHTML = "<div>\u52A0\u8F7D\u5931\u8D25..</div>";
            });
        };
        writeBtn.addEventListener('click', switchToEdit_1);
        ...
        editBtn.addEventListener('click', function () {
            switchToEdit_1();
            saveHandler && saveHandler(textarea.value, function () {
                textarea.value = '';
                switchToEdit_1();
            }, container);
        });
...
function renderSignComment(meta, item) {
    var _this = this;
    var user = meta.user,
        instance = meta.instance;
    ...
    if (canEditFlag && commentPreview && issuePreview) {
        ...
        var editorConfig = {
                ...
                return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.trys.push([1, 3, 4, 5]);
                                return [4 /*yield*/, instance.resource.editComment(item.id, text)];
                            case 2:
                                res = _a.sent();
                                data = res.data;
                                body_1 = data.body, body_html_1 = data.body_html;
                                item.body = body_1;
                                item.body_html = body_html_1;
                                issuePreview.innerHTML = body_html_1;
                                closeEditor_1();
                                return [3 /*break*/, 5];
                            case 3:
                                error_2 = _a.sent();
                                console.error(error_2);
                                if (!error_2) return [2 /*return*/];
                                response = error_2.response, message = error_2.message;
                                // TODO
                                if (response) {
                                    message_1 = response.message;
                                }
                                return [3 /*break*/, 5];
                            case 4:
            ...
            cancelHandler: function cancelHandler(text) {
                return closeEditor_1();
            },
            defaultText: body,
            instance: instance
        };
        var editorEl_1 = renderEditor(editorConfig);
        editorEl_1.classList.add('gh-table__comment-item__editor');
        disappearEL(editorEl_1);
        commentEl.appendChild(editorEl_1);
        // add events to btn elements
        var editBtn = commentEl.querySelector('.gh-talk__comment__edit-btn');
        var deleteBtn = commentEl.querySelector('.gh-talk__comment__delete-btn');
        if (editBtn && deleteBtn) {
            editBtn.addEventListener('click', function () {
                ...
                openEditor_1();
                _autosize2.default.update(textarea);
            });
            deleteBtn.addEventListener('click', function () {
                if (window.confirm('confirm delete this ?')) {
                    // delete action
                    instance.resource.deleteComment(item.id).then(function () {
...
var GhTalk = /** @class */function () {
    function GhTalk(options) {
        ...
        this.rootElement = el;
        this.domRender = new _dom.DOMRender(options, el);
        this.initPrepare();
    }
    GhTalk.prototype.initPrepare = function () {
        return __awaiter(this, void 0, void 0, function () {
            var token, api, data, queryParams, _search, search, token_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        token = localStorage.getItem(_constant.GH_TALK_TOKEN);
                        if (!token) return [3 /*break*/, 2];
                        api = new _api2.default(token, this.options);
                        return [4 /*yield*/, api.detailUser()];
                    case 1:
                        data = _a.sent();
                        if (data && data.login) {
                            this.user = data;
                        ...
                        _a.label = 2;
                    case 2:
                        queryParams = (0, _util.parseQuery)();
                        if (!queryParams.code) return [3 /*break*/, 4];
                        _search = (0, _util.removeCodeInQuery)();
                        search = _search && "?" + _search || '';
                        history.replaceState({}, '', "" + location.origin + location.pathname + search + location.hash);
                        return [4 /*yield*/, (0, _api.exchangeToken)(queryParams.code, this.options)];
                    case 3:
                        token_1 = _a.sent();
                        this.initWithCode(token_1);
                        return [3 /*break*/, 6];
                    case 4:
    ...
    GhTalk.prototype.initWithCode = function (token) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.resource = new _api2.default(token, this.options);
                        if (!!this.user) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.resource.detailUser().then(function (data) {
    ...
    GhTalk.prototype.render = function () {
        var meta = {
            user: this.user,
    ...
    GhTalk.prototype.toLoginIn = function () {
        if (this.options.iframe) {
            (0, _util.openIframeDialog)(this.loginURL);
        } else {
            location.href = this.loginURL;
        }
    };
    Object.defineProperty(GhTalk.prototype, "loginURL", {
        get: function get() {
            var _a = this.options,
            ...
            var redirect_uri = iframe || location.href;
            return _constant.AUTH_URL + "?scope=public_repo&client_id=" + clientId + "&redirect_uri=" + redirect_uri;
        },
        enumerable: true,
        configurable: true
    });
    GhTalk.prototype.loadComments = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.resource.listComments()];
                    case 1:
                        data = _a.sent().data;
                        this.comments = data;
                        return [3 /*break*/, 4];
                    case 2:
                        return [4 /*yield*/, (0, _api.listComments)(this.options)];
                    case 3:
                        data = _a.sent().data;
                        this.comments = data;
                        _a.label = 4;
    ...
    GhTalk.prototype.markdown = function (text) {
        return this.resource.parseMarkdown(text);
    };
    GhTalk.prototype.error = function (msg) {
        console.error(msg);
    };
    GhTalk.prototype.initIframe = function () {
        var _this = this;
        window.addEventListener('message', function (e) {
            var data = e.data;
            if (data && data.type && data.type === 'AUTH') {
                var code = data.code;
                _this.initWithCode(code);
            }
        });
    };
    return GhTalk;
}();
exports.default = GhTalk;
...
var editSVG = exports.editSVG = "<svg aria-hidden=\"true\" class=\"octicon octicon-pencil\" height=\"16\" version=\"1.1\" viewBox=\"0 0 14 16\" width=\"14\"><path fill-rule=\"evenodd\" d=\"M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z\"></path></svg>";
var deleteSVG = exports.deleteSVG = "<svg aria-hidden=\"true\" class=\"octicon octicon-x\" height=\"16\" version=\"1.1\" viewBox=\"0 0 12 16\" width=\"12\"><path fill-rule=\"evenodd\" d=\"M7.48 8l3.75 3.75-1.48 1.48L6 9.48l-3.75 3.75-1.48-1.48L4.52 8 .77 4.25l1.48-1.48L6 6.52l3.75-3.75 1.48 1.48z\"></path></svg>";
var markdownSVG = exports.markdownSVG = "<svg aria-hidden=\"true\" class=\"octicon octicon-markdown v-align-bottom\" height=\"16\" version=\"1.1\" viewBox=\"0 0 16 16\" width=\"16\"><path fill-rule=\"evenodd\" d=\"M14.85 3H1.15C.52 3 0 3.52 0 4.15v7.69C0 12.48.52 13 1.15 13h13.69c.64 0 1.15-.52 1.15-1.15v-7.7C16 3.52 15.48 3 14.85 3zM9 11H7V8L5.5 9.92 4 8v3H2V5h2l1.5 2L7 5h2v6zm2.99.5L9.5 8H11V5h2v3h1.5l-2.51 3.5z\"></path></svg>";
var githubSVG = exports.githubSVG = "<svg aria-hidden=\"true\" class=\"octicon octicon-mark-github\" height=\"32\" version=\"1.1\" viewBox=\"0 0 16 16\" width=\"32\"><path fill-rule=\"evenodd\" d=\"M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8z\"></path></svg>";
var loadingSVG = exports.loadingSVG = "\n<svg width=\"77px\"  height=\"77px\"  xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 100 100\" preserveAspectRatio=\"xMidYMid\" class=\"lds-rolling\" style=\"background: none;\">\n<circle cx=\"50\" cy=\"50\" fill=\"none\" ng-attr-stroke=\"{{config.color}}\" ng-attr-stroke-width=\"{{config.width}}\" ng-attr-r=\"{{config.radius}}\" ng-attr-stroke-dasharray=\"{{config.dasharray}}\" stroke=\"#5699d2\" stroke-width=\"3\" r=\"40\" stroke-dasharray=\"188.49555921538757 64.83185307179586\" transform=\"rotate(197.297 50 50)\">\n  <animateTransform attributeName=\"transform\" type=\"rotate\" calcMode=\"linear\" values=\"0 50 50;360 50 50\" keyTimes=\"0;1\" dur=\"1s\" begin=\"0s\" repeatCount=\"indefinite\"></animateTransform>\n</circle>\n</svg>";
